...
public class Parser {
	...
	public static final int _EOL = 1;
	public static final int _Email = 2;
	// terminals
	public static final int EOF_SYM = 0;
	public static final int EOL_Sym = 1;
	public static final int Email_Sym = 2;
	public static final int NOT_SYM = 3;
	// pragmas
